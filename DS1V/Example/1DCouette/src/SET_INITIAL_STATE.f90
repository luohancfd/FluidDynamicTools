...
ENDIF
!
ALLOCATE (COLLS(NCELLS),WCOLLS(NCELLS),CLSEP(NCELLS),REAC(MNRE),SREAC(MNSR),VAR(23,NCELLS), &
          VARSP(0:13,NCELLS,MSP),VARS(0:32+MSP,2), &
          CS(0:8+MMVM,NCELLS,MSP),CSH(5,NCELLS,MSP),CSS(0:8,2,MSP,2), &   !-isebasti: correcting CS allocation !-han: add CSH
