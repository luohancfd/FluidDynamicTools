#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# modified from https://github.com/bjodah/chempy/blob/master/chempy/util/periodic.py
symbols = (
...
names = (
    ...
    'Livermorium', '(Ununseptium)', '(Ununoctium)', 'Deuterium'
)
...
_relative_atomic_masses = (
    ...
    " [278] [281] [282] [285] [286] [289] [289] [293] [294] [294] 1.007947"
)
